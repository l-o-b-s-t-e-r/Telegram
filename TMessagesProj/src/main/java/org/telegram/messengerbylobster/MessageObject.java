...
public class MessageObject {
    ...
    public boolean needDrawShareButton() {
        if (preview) {
            ...
            if (messageOwner.peer_id != null && messageOwner.peer_id.channel_id != 0 && !getChat(null, null, messageOwner.peer_id.channel_id).noforwards && (messageOwner.via_bot_id == 0 && messageOwner.reply_to == null || type != TYPE_STICKER && type != TYPE_ANIMATED_STICKER)) {
                return true;
            }
        }
        return false;
