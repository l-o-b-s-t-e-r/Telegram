...
public class ReactionCheckCell extends FrameLayout {
    ...
    public ReactionCheckCell(Context context, int padding, boolean dialog) {
        ...
        addView(textView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.MATCH_PARENT, (LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT) | Gravity.TOP, padding, 0, padding, 0));
        ...
        addView(valueTextView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, (LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT) | Gravity.TOP, padding * 3, 0, padding * 3, 0));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0 : AndroidUtilities.dp(60), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.dp(60) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
